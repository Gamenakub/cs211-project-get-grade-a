...
public class AdminFacultyOfficerManagementPageController {
        ...
        try {
            ...
            for (int i=0;i<20;i++) {
                ...
                editButton.setOnAction(actionEvent -> {
                    PopupComponent<Object> requestActionPopup = new PopupComponent<>(new Object(), "/ku/cs/views/admin/admin-faculty-officer-management-popup.fxml","admin-faculty-officer-management-popup",(tablePane.getScene().getWindow()));
    ...
    public void onAddFacultyStaffButton() {
        PopupComponent<Object> popup = new PopupComponent<>(new Object(), "/ku/cs/views/admin/admin-faculty-officer-management-popup.fxml","admin-faculty-officer-management-popup",navBarPane.getScene().getWindow());
        popup.show();
    }
}
