...
public class OfficerRequestFormDropLatePopupPage1Controller extends BasePopup<FormDataModel> {
    ...
    @FXML protected void onButtonToPage3() {
        changeScene(getModel(), "/ku/cs/views/request-forms/officer-form-drop-late-popup-page3.fxml","form");
    }
