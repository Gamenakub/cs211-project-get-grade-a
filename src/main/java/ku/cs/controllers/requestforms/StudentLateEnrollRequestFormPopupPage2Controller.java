...
public class StudentLateEnrollRequestFormPopupPage2Controller extends BasePopup<Object> {
    ...
    public void onButtonToPage1() {
        changeScene(new Object(), "/ku/cs/views/request-forms/student-late-enroll-request-form-popup-page1.fxml", "form");
    }
    @FXML public void onButtonToPage3() {
        changeScene(new Object(), "/ku/cs/views/request-forms/student-late-enroll-request-form-popup-page3.fxml", "form");
    }
}
